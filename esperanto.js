	...
	*/
	...
	function populateIdentifierReplacements ( bundle ) {
		...
		bundle.modules.forEach( function(mod ) {
			...
			if ( ~mod.id.indexOf('getValue') ) console.log( 'I chose ' + JSON.stringify(mod.identifierReplacements) + '\nbecause\n' + JSON.stringify((other || { ast: { _topLevelNames: 'bwahahahahaha' } }).ast._topLevelNames));
		});
