define(['exports'], function (exports) {
	...
	function object__extend ( target, ...sources ) {
		var prop, source;
	...
	var trim__default = str => str.trim();
	...
	function extendFn ( childFn, parent ) {
		...
		if ( typeof parent !== 'function' ) {
			...
			parentFn = function ( data ) {
				...
				parent = wrap__default( parent, () => {}, true );
	...
	function getDynamicTemplate ( ractive, fn ) {
		var helper = templateConfigurator__createHelper( parser.getParseOptions( ractive ) );
	...
	var Mustache = {
		getValue: getValue__Mustache$getValue,
		init: init__Mustache$init,
		resolve: resolve__Mustache$resolve,
	...
	Section.prototype = {
		...
		render: render__Section$render,
		resolve: Mustache.resolve,
		setValue: Section$setValue,
		toString: toString__Section$toString,
		unbind: Section$unbind,
		unrender: unrender__Section$unrender,
		update: update__Section$update
	};
	...
	if ( !isClient ) {
		...
		animateStyle = function ( style, value, options ) {
			...
			var promise = new Promise( resolve => {
				...
				computedStyle = animateStyle__getComputedStyle( this.node );
				...
				while ( i-- ) {
					...
					if ( current != to[ prop ] ) { // use != instead of !==, so we can compare strings with numbers
						...
						// e.g. height='auto'
						this.node.style[ prefix__default( prop ) ] = current;
					}
				}
	...
	function Viewmodel$register ( keypath, dependant, group = 'default' ) {
	...
	function Viewmodel$unregister ( keypath, dependant, group = 'default' ) {
	...
	Viewmodel.prototype = {
		...
		teardown: teardown__Viewmodel$teardown,
	...
	var proto = {
		...
		updateModel: updateModel__Ractive$updateModel
	};
	...
	Ractive.prototype = object__extend( proto, defaults );
